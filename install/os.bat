...
ECHO ณ You have chosen to install the MMURTL Operating System  ณ
ECHO ณ files from this disc to your C: hard drive.             ณ
ECHO ณ                                                         ณ
ECHO ณ                                                         ณ
ECHO ณ The files will take up less then 1 megabyte of space.   ณ
ECHO ณ                                                         ณ
ECHO ณ                                                         ณ
